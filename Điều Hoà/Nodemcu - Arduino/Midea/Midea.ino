...
#define AC_OFF      0
#define AC_COOL     MIDEA_AC_COOL
#define AC_FAN_ONLY MIDEA_AC_FAN
#define AC_DRY      MIDEA_AC_DRY
#define FAN_LOW     MIDEA_AC_FAN_LOW
#define FAN_MID     MIDEA_AC_FAN_MED
#define FAN_HIGH    MIDEA_AC_FAN_HI
#define FAN_AUTO    MIDEA_AC_FAN_AUTO
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  {
    mideair.on();
    mideair.setFan(fanMode);
    mideair.setMode(mode);
    mideair.setTemp(temp);
    /*if(swingMode == SWING_OFF)
    {
      mideair.setSwingVertical(kPanasonicAcSwingVUp);
      mideair.setSwingHorizontal(kPanasonicAcSwingHMiddle);
    }
    else
    {
      mideair.setSwingVertical(kPanasonicAcSwingVAuto);
      mideair.setSwingHorizontal(kPanasonicAcSwingHAuto);
    }*/
  }
  mideair.send();
  EEPROM.commit();
